...
document.getElementById('sortByIdIcon').addEventListener('click', function() {
    ...
    sortTableByColumn(document.querySelector('.dashboard-table-types'), 0, true, isAsc);
...
document.getElementById('sortByNameIcon').addEventListener('click', function() {
    ...
    sortTableByColumn(document.querySelector('.dashboard-table-types'), 1, false, isAsc);
...
document.getElementById('sortByCountIcon').addEventListener('click', function() {
    ...
    sortTableByColumn(document.querySelector('.dashboard-table-types'), 2, true, isAsc);
