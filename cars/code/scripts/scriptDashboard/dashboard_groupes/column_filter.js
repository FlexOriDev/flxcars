...
document.getElementById('sortByIdIcon').addEventListener('click', function() {
    ...
    sortTableByColumn(document.querySelector('.dashboard-table-groupes'), 0, true, isAsc);
...
document.getElementById('sortByNameIcon').addEventListener('click', function() {
    ...
    sortTableByColumn(document.querySelector('.dashboard-table-groupes'), 1, false, isAsc);
...
document.getElementById('sortByConstructorIcon').addEventListener('click', function() {
    ...
    sortTableByColumn(document.querySelector('.dashboard-table-groupes'), 2, false, isAsc);
    sortByConstructorIcon.src = isAsc ? '../../library/iconsDashboard/descendant.png' : '../../library/iconsDashboard/ascendant.png';
});
...
document.getElementById('sortByCountIcon').addEventListener('click', function() {
    ...
    sortTableByColumn(document.querySelector('.dashboard-table-groupes'), 3, true, isAsc);
