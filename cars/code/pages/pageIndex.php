...
<head>
    ...
    <link href="../css/styleIndex.css" rel="stylesheet"><!--lien vers feuille de style avec le nom de celle-ci-->
    <title>Flx Cars</title><!--Titre de la page web-->
</head>

<!------------------------------------------INCLUDES---------------------------------------------------->

<?php include '../includesHeaderFooter/includeHeader.php'; ?>

<!----------PATH---------->
<div class="global-pathButtons">
        <a class="global-boutonPathActual">Accueil</a>
</div>
<!---------------------------------------------MAIN----------------------------------------------------->
<main>
