...
<div class="input-container">
    ...
    <script src="../scripts/ajouteFiche/resume.js"></script>
<br>
<!-- HISTOIRE -->
...
<textarea id="editor" name="editor" class="history"><?php echo $editor ?></textarea>
    ...
    <script src="../scripts/ajouteFiche/editor.js"></script>
...
<div class="table-container">
    ...
    <script src="../scripts/ajouteFiche/table.js"></script>
...
<div class="selected-images-container">
    ...
    <script src="../scripts/ajouteFiche/pictures.js"></script>
